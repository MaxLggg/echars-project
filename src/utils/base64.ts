...
let _getbyte64 = function _getbyte64(s: string, i: number) {
...
let _getbyte = function _getbyte(s: string, i: number) {
...
export let decode = function decode(s: string) {
  let pads = 0;
  let i;
  let b10;
  let imax = s.length;
...
export let encode = function encode(s: string) {
  let news = s;
